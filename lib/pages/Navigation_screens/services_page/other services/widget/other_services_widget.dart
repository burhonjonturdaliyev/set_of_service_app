...
class other_services_widget extends StatelessWidget {
  ...
  other_services_widget({super.key, required this.model});
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
        ...
        itemBuilder: (context, index) => job_items(
              model[index],
              colour[index % 1],
            ));
  }
